...
const STORAGE_KEY = "zeb-dashboard-theme";
...
const FONT_STORAGE_KEY = "zeb-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `zeb_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "zeb-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-zeb-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-zeb-theme-font", "true");
