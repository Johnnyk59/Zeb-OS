 ...
 * `window.__ZEB_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Zeb brand in the top bar
 ...
 *  `window.__ZEB_PLUGINS__.registerSlot(...)`.
 *
