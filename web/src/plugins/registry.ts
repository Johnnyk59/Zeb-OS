 ...
 *
 * Plugins call window.__ZEB_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ZEB_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ZEB_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ZEB_PLUGIN_SDK__ = {
    ...
    // window.__ZEB_SESSION_TOKEN__ directly.
    authedFetch,
