 ...
 *
 * Values mirror zeb_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Zeb default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Zeb' default when unset). */
