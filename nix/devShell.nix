...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      zebNpmLib = self'.packages.default.passthru.zebNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. zeb-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Zeb Agent dev shell"
          ${combinedNonNpm}
          ${zebNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'zeb' to start."
        '';
      };
    };
}
