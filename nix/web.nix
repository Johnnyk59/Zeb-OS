# nix/web.nix — Zeb Web Dashboard (Vite/React) frontend build
{ pkgs, zebNpmLib, ... }:
let
  npm = zebNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "zeb-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../zeb_cli/web_dist for the
