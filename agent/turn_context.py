...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``zeb logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Zeb only initiates compaction in "zeb" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Zeb preflight compression for codex app-server "
                "(mode=%s); Zeb will not start thread compaction here.",
