"""Vertex AI (Google Cloud) adapter for Zeb Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Zeb to use Gemini models via Google Cloud with
...
# who installed plain `zeb-agent` and only later selected a Gemini model.
try:
