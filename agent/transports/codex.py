...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Zeb's web-provider config and
        ...
        # native search engine for xAI sessions instead of Zeb's
        # configured web provider (Tavily/etc.), and those results bypass
        # Zeb's tool-trace / citation plumbing (they arrive baked into the
