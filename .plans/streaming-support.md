# Streaming LLM Response Support for Zeb Agent
...
```
ZEB_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZEB_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zeb_cli/config.py` | 1 | +streaming config defaults |
