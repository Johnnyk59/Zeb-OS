...
def _profile_user_agent() -> str:
    """Return a ``zeb-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from zeb_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"zeb-cli/{_ver}"
    except Exception:
        return "zeb-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # zeb-cli UA so the catalog endpoint is reachable.
