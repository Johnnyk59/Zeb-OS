...
Built for [Zeb Agent](https://github.com/NousResearch/zeb-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/zeb-agent/skills/creative/ascii-video`](https://github.com/NousResearch/zeb-agent/tree/main/skills/creative/ascii-video) via PR.
