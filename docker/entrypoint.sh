...
# by /etc/cont-init.d/01-zeb-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs zeb"
...
echo "[zeb] WARNING: docker/entrypoint.sh is a deprecated shim under " \
