#!/usr/bin/env python3
"""
SWE Runner with Zeb Trajectory Format

A runner that uses Zeb-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Zeb-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Zeb-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Zeb format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Zeb-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Zeb-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Zeb Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Zeb-Agent's built-in execution environments
    and outputs trajectories in Zeb-Agent format.
    """
    ...
    def _convert_to_zeb_format(
        ...
        """
        Convert internal message format to Zeb trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Zeb trajectory format
        trajectory = self._convert_to_zeb_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Zeb trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Zeb Trajectory Format")
    print("=" * 60)
