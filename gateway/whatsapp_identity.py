...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ZEB_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_zeb_dir("platforms/whatsapp/session", "whatsapp/session")
