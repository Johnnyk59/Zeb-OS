...
Data file: $ZEB_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZEB_HOME = Path(os.environ.get("ZEB_HOME", Path.home() / ".zeb"))
DATA_DIR = _ZEB_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
