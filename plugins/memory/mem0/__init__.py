...
Configuration
-------------
Secret (lives in $ZEB_HOME/.env or the environment):
...
Behavioral settings (live in $ZEB_HOME/mem0.json, set via `zeb memory
setup`):
  ...
  agent_id           — Agent identifier (default: zeb)
...
def _load_config() -> dict:
    """Load config from env vars, with $ZEB_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "zeb"),
        "oss": {},
    }
    ...
    config_path = get_zeb_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, zeb_home):
        """Write config to $ZEB_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ZEB_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "zeb")
