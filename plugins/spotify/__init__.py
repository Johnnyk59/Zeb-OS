...
``_check_spotify_available()`` — when the user has not run ``zeb auth
spotify``, the tools remain registered (so they appear in ``zeb
...
The Spotify auth flow (``zeb auth spotify``), CLI plumbing, and docs
