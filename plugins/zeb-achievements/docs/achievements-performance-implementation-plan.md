# Zeb Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.zeb/plugins/zeb-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.zeb/plugins/zeb-achievements/scan_checkpoint.json`.
