...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Zeb gateway adapter.

    Each inbound phone number gets its own Zeb session (multi-tenant).
...
# static dict in zeb_cli/gateway.py, and the _send_sms dispatch in
