...
required — uses aiohttp which is already a Zeb dependency.
...
def interactive_setup() -> None:
    ...
    ``zeb_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Zeb delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # zeb_cli/setup.py::_setup_mattermost function.
