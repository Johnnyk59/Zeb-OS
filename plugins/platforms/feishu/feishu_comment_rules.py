...
Config: ~/.zeb/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.zeb/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_zeb_home()`` helper (ZEB_HOME-aware and
...
RULES_FILE = get_zeb_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_zeb_home() / "feishu_comment_pairing.json"
