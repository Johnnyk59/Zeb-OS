...
await build({
  ...
  // Skip the prebuilt @zeb/ink bundle and inline the source instead:
  ...
  alias: { '@zeb/ink': resolve(root, 'packages/zeb-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The zeb_cli launcher
