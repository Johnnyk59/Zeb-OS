...
import type { ScrollBoxHandle } from '@zeb/ink'
import { evictInkCaches } from '@zeb/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZEB_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
