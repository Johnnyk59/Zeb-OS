import { Box, type ScrollBoxHandle, stringWidth, Text } from '@zeb/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ZEB_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ZEB_DEV_CREDITS), lowest priority,
