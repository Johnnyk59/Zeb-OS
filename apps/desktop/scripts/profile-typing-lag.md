...
cd apps/desktop
XCURSOR_SIZE=24 ZEB_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/zeb-typing
# → /tmp/zeb-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/zeb-typing.before.heapsnapshot
# → /tmp/zeb-typing.after.heapsnapshot
```
