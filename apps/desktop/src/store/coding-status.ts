...
import type { ZebGitWorktree, ZebRepoStatus } from '@/global'
...
export const $repoStatus = atom<ZebRepoStatus | null>(null)
...
export const $repoWorktrees = atom<ZebGitWorktree[]>([])
