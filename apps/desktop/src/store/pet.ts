...
export interface PetInfo {
  ...
  // the Zeb "run" activity state uses the in-place running row).
 ...
 * ZEB_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'zeb.desktop.pet-roam.v1'
