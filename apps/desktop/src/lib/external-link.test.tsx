...
const desktopWindow = window as unknown as { zebDesktop?: Window['zebDesktop'] }
const initialZebDesktop = desktopWindow.zebDesktop

function installDesktopBridge(partial: Partial<Window['zebDesktop']> = {}) {
  desktopWindow.zebDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['zebDesktop']
}
...
afterEach(() => {
  ...
  if (initialZebDesktop) {
    desktopWindow.zebDesktop = initialZebDesktop
  } else {
    delete desktopWindow.zebDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['zebDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['zebDesktop']['openExternal'] })
