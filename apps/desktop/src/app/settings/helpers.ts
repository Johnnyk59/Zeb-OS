...
import type { ZebConfigRecord, ToolsetInfo } from '@/types/zeb'
...
export function getNested(obj: ZebConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ZebConfigRecord, path: string, value: unknown): ZebConfigRecord {
...
function personalityOptions(config: ZebConfigRecord): string[] {
