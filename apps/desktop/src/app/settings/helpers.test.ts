...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: ZebConfigRecord = { display: { theme: 'mono' } }
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // ZEB_QWEN_ shares the ZEB_ stem with other integrations.
      expect(providerGroup('ZEB_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
