...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/zeb'
...
// / Program Files), which buried any files Zeb wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.zebDesktop` is
    ...
    const settings = window.zebDesktop?.settings
