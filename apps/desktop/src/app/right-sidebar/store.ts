...
const TAKEOVER_KEY = 'zeb.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Zeb can't clear via the API — the user
 *  sees exactly what runs instead of Zeb silently deleting their creds. */
