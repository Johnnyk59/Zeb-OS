import type { ZebReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ZebReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ZebReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
