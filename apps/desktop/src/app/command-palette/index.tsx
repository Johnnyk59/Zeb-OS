...
import { getZebConfigRecord, listAllProfileSessions } from '@/zeb'
...
// Zeb session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-zeb',
            keywords: ['update', 'upgrade', 'zeb', 'version', 'system', 'restart'],
            label: cc.updateZeb,
