...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/zeb'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('zeb:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('zeb:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Zeb to
