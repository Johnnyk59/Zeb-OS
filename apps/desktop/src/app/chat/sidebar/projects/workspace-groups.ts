...
import type { ProjectInfo, SessionInfo } from '@/zeb'
 ...
 * repo shows its branches/worktrees even when they have no Zeb sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ZebGitWorktree[]
): SidebarSessionGroup[] {
