...
export const en: Translations = {
  ...
  boot: {
    ready: 'Zeb Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zeb settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingZebDesktop: 'Starting Zeb Desktop…'
    },
    errors: {
      backgroundExited: 'Zeb background process exited.',
      backgroundExitedDuringStartup: 'Zeb background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zeb backend is older than this desktop build and may not work correctly. Update to align them.',
    updateZeb: 'Update Zeb',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zeb Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zeb is waiting for your response.',
      turnDoneTitle: 'Zeb finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zeb defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Zeb is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Zeb asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Zeb was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Zeb follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Zeb is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Zeb, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Zeb checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Zeb configuration...',
    ...
    gateway: {
      ...
      intro:
        'Zeb Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Zeb backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ZEB_DESKTOP_REMOTE_URL and ZEB_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zeb backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Zeb backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /zeb.',
      ...
      restartingMessage: 'Zeb Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Zeb ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Zeb runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via zeb curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Zeb builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Zeb to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Zeb to generate pets.',
      backgroundHint: 'You can close this — Zeb will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Zeb desktop' },
    ...
    zebActiveSessions: (version, count) => `Zeb ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@zeb:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zeb environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zeb will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Zeb backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Zeb. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Zeb...',
    placeholderReconnecting: 'Reconnecting to Zeb…',
    ...
    attachUrlDesc: 'Zeb will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Zeb can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Zeb from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zeb will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Zeb desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Zeb updater takes over in its own window and reopens Zeb automatically when it’s done. Please don’t reopen Zeb yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zeb reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Zeb reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Zeb needs a one-time install',
    ...
    settingUpTitle: 'Setting up Zeb Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zeb CLI or desktop instance is running. Stop any running Zeb instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Zeb Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zeb is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zeb…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Zeb',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zeb at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Zeb connects automatically',
    ...
    authorizeThere: 'Authorize Zeb there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zeb there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Zeb Desktop v${version}`,
      ...
      gatewayTitle: 'Zeb inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Zeb will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zeb is restarting...',
      askRestart: 'Ask Zeb to restart the server',
      lookingRestart: taskId => `Zeb is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zeb is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Zeb finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zeb could not restart the server.',
      stillWorking:
        'Zeb is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zeb is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Zeb gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.zeb/config.yaml). Zeb won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Zeb needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zeb needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zeb Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zeb Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `zeb gateway` running?'
    }
  },
