  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://zeb-agent.nousresearch.com/docs' },
    ...
    expect(view.title).toBe('Failed to open zeb-agent.nousresearch.com')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://zeb-agent.nousresearch.com/docs' },
        result: { success: true, url: 'https://zeb-agent.nousresearch.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened zeb-agent.nousresearch.com')
  })
})
