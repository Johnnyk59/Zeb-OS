...
const config: Config = {
  ...
  url: 'https://zeb-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'NousResearch',
  projectName: 'zeb-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-zeb-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NousResearch/zeb-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/zeb-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://zeb-agent.nousresearch.com/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/NousResearch/zeb-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Issues', href: 'https://github.com/NousResearch/zeb-agent/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://zeb-agent.nousresearch.com/' },
            { label: 'GitHub', href: 'https://github.com/NousResearch/zeb-agent' },
