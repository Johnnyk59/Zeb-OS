#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Zeb docs site.
...
Both publish at:
  https://zeb-agent.nousresearch.com/docs/llms.txt
  https://zeb-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://zeb-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Zeb as a Python Library", None),
        ("guides/use-mcp-with-zeb", "Use MCP with Zeb", None),
        ("guides/use-voice-mode-with-zeb", "Use Voice Mode with Zeb", None),
        ("guides/use-soul-with-zeb", "Use SOUL.md with Zeb", None),
        ("guides/build-a-zeb-plugin", "Build a Zeb Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Zeb"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "zeb-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/zeb-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Zeb Agent — Full Documentation\n",
        (
            "This file is the entire Zeb Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Zeb, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://zeb-agent.nousresearch.com/docs\n",
        "Short index: https://zeb-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
