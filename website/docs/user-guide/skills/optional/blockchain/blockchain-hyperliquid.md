...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Zeb Agent |
| License | MIT |
...
The script reads `${ZEB_HOME:-~/.zeb}/.env` for two optional defaults:
...
Helper script: `~/.zeb/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.zeb/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ZEB_HOME:-~/.zeb}/.env`.
...
```bash
python3 ~/.zeb/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.zeb/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
