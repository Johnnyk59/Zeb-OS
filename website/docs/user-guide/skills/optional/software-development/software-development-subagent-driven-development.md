...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Zeb Agent (adapted from obra/superpowers) |
| License | MIT |
