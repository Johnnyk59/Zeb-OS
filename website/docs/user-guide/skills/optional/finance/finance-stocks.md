...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Zeb Agent |
| License | MIT |
...
```
SCRIPT=~/.zeb/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.zeb/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
