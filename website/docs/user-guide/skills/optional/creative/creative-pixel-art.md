...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.zeb/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.zeb/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Zeb installs package this)
