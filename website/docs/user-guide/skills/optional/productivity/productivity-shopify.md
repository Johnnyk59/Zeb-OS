...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Zeb","productType":"Apparel","tags":["test"]}}'
```
