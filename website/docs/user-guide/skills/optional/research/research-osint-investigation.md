...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Zeb Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ZEB_OSINT_CACHE/icij/ (default: ~/.cache/zeb-osint/icij/).
...
# Set ZEB_OSINT_UA=your-app/1.0 (your@email) to identify yourself
