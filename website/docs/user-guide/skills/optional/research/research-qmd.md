...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/research/qmd` |
...
Zeb Agent via the native MCP client. This is the preferred
...
Then configure Zeb Agent to connect via HTTP:
