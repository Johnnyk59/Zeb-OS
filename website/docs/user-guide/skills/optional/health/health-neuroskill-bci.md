...
| | |
|---|---|
| Source | Optional — install with `zeb skills install official/health/neuroskill-bci` |
...
Connect Zeb to a running [NeuroSkill](https://neuroskill.com/) instance to read
