...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Zeb Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Zeb Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Zeb core? Start with [Build a Zeb Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Zeb itself? Start with [Adding Tools](./adding-tools.md)
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.zeb/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.zeb` — use `get_zeb_home()` from `zeb_constants` for code paths and `display_zeb_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/zeb-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/zeb-agent/blob/main/LICENSE).
