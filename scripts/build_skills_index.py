#!/usr/bin/env python3
"""Build the Zeb Skills Index — a centralized JSON catalog of all skills.
...
`zeb skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZEB_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Zeb Skills Index...", flush=True)
