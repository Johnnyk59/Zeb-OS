...
DEFAULT_DATASETS = [
    ...
    "NousResearch/zeb-agent-megascience-sft1",
    "NousResearch/Zeb-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Zeb-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-zeb-agent"
]
