...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from zeb_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ZEB_OVERLAYS
        overlay = ZEB_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify zeb doctor recognizes Xiaomi env vars."""
