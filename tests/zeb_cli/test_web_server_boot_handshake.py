...
Simulates a slow zeb_cli.gateway import (15-30 s on a fresh Windows install
...
1. _lifespan fire-and-forget: patched _warm_gateway_module sleeps N seconds in
   ...
   blocked, ZEB_DASHBOARD_READY would fire immediately).
...
import zeb_cli.web_server as web_server_mod
...
def test_lifespan_warmup_is_nonblocking():
    ...
    ZEB_DASHBOARD_READY would have fired without delay.
    """
