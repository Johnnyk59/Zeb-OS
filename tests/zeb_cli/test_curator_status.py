"""Tests for `zeb curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import zeb_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ZEB_HOME with real agent-created skills on disk."""
    home = tmp_path / ".zeb"
    skills = home / "skills"
    ...
    from zeb_cli import curator as curator_cli
