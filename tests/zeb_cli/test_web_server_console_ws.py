"""Dashboard Zeb Console websocket tests."""
...
@pytest.fixture
def console_client(monkeypatch, _isolate_zeb_home):
...
def test_console_ws_uses_hosted_context_for_opt_data_policy(console_client, monkeypatch):
    monkeypatch.setattr(web_server, "_default_zeb_root_is_opt_data", lambda: True)
