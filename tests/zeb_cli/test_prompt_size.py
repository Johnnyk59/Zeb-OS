"""Tests for the ``zeb prompt-size`` diagnostic (issue #34667)."""
...
from zeb_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(zeb_home, memory_text="", user_text=""):
    mem_dir = zeb_home / "memories"
...
def _seed_skill(zeb_home, name, description):
    skill_dir = zeb_home / "skills" / "demo" / name
