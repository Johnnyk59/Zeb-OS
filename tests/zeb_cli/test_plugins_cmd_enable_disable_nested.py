...
the *mutation* side: `zeb plugins enable/disable` must resolve a bare name
...
class TestEnableDisableNested:
    @patch("zeb_cli.plugins.get_bundled_plugins_dir")
    @patch("zeb_cli.plugins_cmd._plugins_dir")
    @patch("zeb_cli.plugins_cmd._save_disabled_set")
    @patch("zeb_cli.plugins_cmd._save_enabled_set")
    @patch("zeb_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("zeb_cli.plugins_cmd._get_enabled_set", return_value=set())
    def test_enable_bare_name_writes_key(
        ...
        from zeb_cli.plugins_cmd import cmd_enable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
    ...
    def test_enable_clears_manifest_name_alias_from_disabled(
        ...
        ``zeb plugins disable web-firecrawl`` gets ``web-firecrawl`` in
        ...
        with patch(
            "zeb_cli.plugins_cmd._get_disabled_set",
    ...
    def test_disable_bare_name_writes_key_and_clears_alias(
        ...
        from zeb_cli.plugins_cmd import cmd_disable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
...
class TestEnableToolOverrideConsent:
    ...
    @patch("zeb_cli.plugins.get_bundled_plugins_dir")
    @patch("zeb_cli.plugins_cmd._plugins_dir")
    @patch("zeb_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("zeb_cli.plugins_cmd._save_disabled_set")
    @patch("zeb_cli.plugins_cmd._save_enabled_set")
    @patch("zeb_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("zeb_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `zeb plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from zeb_cli.plugins_cmd import _run_composite_fallback
