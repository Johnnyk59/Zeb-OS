...
def worker_loop(worker_id: int, zeb_home: str, result_file: str) -> None:
...
def reclaimer_loop(zeb_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="zeb_mixed_stress_")
    print(f"ZEB_HOME = {home}")
