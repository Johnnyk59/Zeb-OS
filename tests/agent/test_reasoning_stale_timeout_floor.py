...
thinking phase.  Zeb's default cloud-stream stale detector
(``ZEB_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ZEB_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
