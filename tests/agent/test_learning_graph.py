...
def test_zeb_meta_tolerates_non_dict():
    assert learning_graph._zeb_meta({"metadata": "junk"}) == {}
    assert learning_graph._zeb_meta({"metadata": {"zeb": "junk"}}) == {}
    assert learning_graph._zeb_meta({"metadata": {"zeb": {"category": "x"}}}) == {"category": "x"}
