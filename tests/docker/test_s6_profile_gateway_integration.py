...
The unit tests in tests/zeb_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned zeb-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/zeb")
from zeb_cli.service_manager import S6ServiceManager
