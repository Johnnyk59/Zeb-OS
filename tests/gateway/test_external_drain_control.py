...
Q-B, exercises a real `zeb gateway run`); these lock the unit contract.
"""
...
class TestMarkerContract:
    ...
    def test_path_respects_zeb_home(self, home):
...
class TestInstantiationEpoch:
    ...
    def test_marker_from_prior_instantiation_reads_as_absent(self, home, monkeypatch):
        ...
        # container/VM instantiation survives on the durable ZEB_HOME volume
