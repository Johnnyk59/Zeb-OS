"""Tests for _setup_feishu() in zeb_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("zeb_cli.config.save_env_value", side_effect=mock_save), \
         patch("zeb_cli.config.get_env_value", side_effect=mock_get), \
         patch("zeb_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("zeb_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("zeb_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("zeb_cli.cli_output.print_header"), \
         patch("zeb_cli.cli_output.print_info"), \
         patch("zeb_cli.cli_output.print_success"), \
         patch("zeb_cli.cli_output.print_warning"), \
         patch("zeb_cli.cli_output.print_error"), \
