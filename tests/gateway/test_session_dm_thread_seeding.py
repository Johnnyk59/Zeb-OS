...
def store(tmp_path, monkeypatch):
    ...
    ~/.zeb/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at zeb_state import time, before pytest's ZEB_HOME monkeypatch
    fires — the autouse fixture's ZEB_HOME override doesn't help here.)
    """
    import zeb_state
