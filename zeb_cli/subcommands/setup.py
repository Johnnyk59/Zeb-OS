...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Zeb Agent with an interactive wizard. "
        "Run a specific section: zeb setup model|tts|terminal|gateway|tools|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'zeb setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
