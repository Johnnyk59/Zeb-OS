...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'zeb tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # zeb tools disable <name...> [--platform cli]
    ...
    # zeb tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `zeb tools` runs after you pick a provider that\n"
