"""
Zeb CLI - Unified command-line interface for Zeb Agent.

Provides subcommands for:
- zeb chat          - Interactive chat (same as ./zeb)
- zeb gateway       - Run gateway in foreground
- zeb gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `zeb setup` on a fresh Pi.
    ...
    zeb_cli/stdio.py::configure_windows_stdio() runs later from the entry
