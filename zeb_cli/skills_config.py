"""
Skills configuration for Zeb Agent.
`zeb skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zeb/config.yaml under:
...
from zeb_cli.config import cfg_get, load_config, save_config
from zeb_cli.colors import Colors, color
from zeb_cli.platforms import PLATFORMS as _PLATFORMS
