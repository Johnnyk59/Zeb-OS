...
def _has_zeb_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ZEB_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ZebHome", str(get_zeb_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = zeb_subprocess_env(inherit_credentials=False)
