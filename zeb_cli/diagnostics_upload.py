"""Client for uploading ``zeb debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``zeb debug share``.
...
NAS_BASE = os.environ.get(
    "ZEB_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "zeb-agent/debug-share"
