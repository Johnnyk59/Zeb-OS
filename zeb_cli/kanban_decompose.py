...
Invoked by ``zeb kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Zeb Agent board.
...
def _profile_author() -> str:
    """Mirror of ``zeb_cli.kanban._profile_author``."""
    return (
