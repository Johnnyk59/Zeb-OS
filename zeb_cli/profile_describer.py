...
Used by ``zeb profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``zeb_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Zeb Agent kanban board.
...
Rules:
  ...
  - Never write "Zeb Agent profile" or other meta-narration.
