...
Entry point: ``zeb whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``zeb_cli/main.py``).
...
Zeb gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Zeb to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Zeb needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Zeb gateway in another terminal:")
    print("         zeb gateway")
    print()
    ...
    print()
    print("  Docs: https://zeb-agent.nousresearch.com/docs/user-guide/")
