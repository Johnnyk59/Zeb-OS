"""Zeb middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "zeb.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "zeb.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Zeb sends them.
    """
