...
Trust levels:
  - builtin:   Ships with Zeb. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zeb/\.env|\~/\.zeb/\.env',
     "zeb_env_access", "critical", "exfiltration",
     "directly references Zeb secrets file"),
    ...
    (r'\.zeb/config\.yaml|\.zeb/SOUL\.md',
     "zeb_config_mod", "critical", "persistence",
     "references Zeb configuration files directly"),
...
# scan. `.skillignore` is the Zeb-native name; `.clawhubignore` is honored
