...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/zeb-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/zeb-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/zeb-results"
HEREDOC_MARKER = "ZEB_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"ZEB_PERSIST_{uuid.uuid4().hex[:8]}"
