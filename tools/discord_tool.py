...
Only included in the zeb-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Zeb-Agent (https://github.com/NousResearch/zeb-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_zeb_home() / "cache" / "discord_capabilities.json"
